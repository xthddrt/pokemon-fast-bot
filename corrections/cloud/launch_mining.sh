...
export N=${N:-20}
export ARMS=${ARMS:-0}
export PAIRS=${PAIRS:-200}
export PHANTOM_MODE=${PHANTOM_MODE:-cut}
export PHANTOM_ALPHA=${PHANTOM_ALPHA:-0.5}
export OPPS="${OPPS:-argmax}"
export COLLAPSED=${COLLAPSED:-0}
export GEN_CHUNK=${GEN_CHUNK:-750}
export N_EARLY=${N_EARLY:-8}
export N_MID=${N_MID:-8}
export N_LATE=${N_LATE:-10}
